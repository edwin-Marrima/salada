...
func NewWrongFunctionParametersError(functionName, expectedParameters, providedParameters string) error {
	return fmt.Errorf(errWrongFunctionParameters, functionName, expectedParameters, providedParameters)
}
